      ...
      sections={[
        {
          ...
          body: [
            { bn: "ভুল পণ্য বা ভুল মাত্রা (স্ট্রেংথ) পাঠানো হয়েছে।", en: "A wrong product or wrong strength was delivered." },
            {
            ...
            { bn: "অর্ডারের কোনো আইটেম মিসিং আছে।", en: "An item from your order is missing." },
            {
