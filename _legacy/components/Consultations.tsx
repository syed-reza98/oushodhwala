        ...
        {rows.map((a) => (
          <div key={a.id} className="rounded-xl border border-border bg-card p-3">
            ...
            <div className="mt-2 flex flex-wrap gap-1.5">
              <Link href={`/consultation/${encodeURIComponent(a.id)}`} className="rounded-lg border border-border px-2 py-1 text-[10px] font-semibold">রুম</Link>
              <Link href={`/rx/${encodeURIComponent(a.id)}`} className="rounded-lg border border-border px-2 py-1 text-[10px] font-semibold">প্রেসক্রিপশন</Link>
