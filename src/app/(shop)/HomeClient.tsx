...
export default function HomeClient() {
  const t = useT();
  const { products, categories, settings, labTests } = useCatalog();
    ...
    <div className="pb-4">
      ...
      <section className="grid gap-3 pt-5 lg:grid-cols-3 lg:grid-rows-2">
        <div className="relative overflow-hidden rounded-2xl brand-gradient p-6 text-primary-foreground shadow-[var(--shadow-elevated)] lg:col-span-2 lg:row-span-2 lg:p-9">
          <img
            src={typeof bannerMedicine === "string" ? bannerMedicine : bannerMedicine.src}
            alt=""
            aria-hidden
          ...
          <div className="relative max-w-xl">
            <span className="inline-flex items-center gap-1.5 rounded-full bg-primary-foreground/15 px-3 py-1 text-[11px] font-semibold">
              ...
              {t("DGDA অনুমোদিত সোর্স · ১০০% অরিজিনাল", "DGDA-approved source · 100% authentic")}
            </span>
            <h1 className="mt-4 font-display text-3xl font-extrabold leading-tight lg:text-5xl">
              {t("বাংলাদেশের বিশ্বস্ত", "Bangladesh's most trusted")}{" "}
              <br className="hidden sm:block" /> {t("অনলাইন ফার্মেসি", "online pharmacy")}
            </h1>
        ...
        {settings.expressEnabled ? (
          <div className="surface-card flex flex-col justify-between gap-3 border-sale/40 p-5">
            <div>
              ...
              <p className="mt-3 font-display text-base font-bold text-navy">
                {t("জরুরি ডেলিভারি", "Express delivery")} — {settings.expressEta}
              </p>
              <p className="mt-1 text-xs text-muted-foreground">
                {t(
                  "ইমার্জেন্সি ঔষধ ও অক্সিজেন অগ্রাধিকারে পৌঁছে দেওয়া হয়।",
                  "Emergency medicine and oxygen delivered on priority.",
                )}
              </p>
            </div>
            <a
          ...
          <div className="surface-card p-5">
            ...
            <p className="mt-3 font-display text-base font-bold text-navy">
              {t("ফার্মাসিস্ট সাপোর্ট", "Pharmacist support")}
            </p>
            <p className="mt-1 text-xs text-muted-foreground">
              {t("প্রতিদিন সকাল ৮টা – রাত ১১টা", "Every day 8 AM – 11 PM")}
            </p>
          </div>
        )}
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <span className="mt-4">
              <span className="block font-display text-sm font-bold text-navy">
                {t("ল্যাব টেস্ট", "Lab test")}
              </span>
              <span className="block text-[10px] text-muted-foreground">
                {t("ঘরে বসে স্যাম্পল", "Sample collection at home")}
              </span>
            </span>
          </Link>
          <Link
          ...
          >
            ...
            <span className="mt-4">
              <span className="block font-display text-sm font-bold text-navy">
                {t("ডাক্তার পরামর্শ", "Doctor consultation")}
              </span>
              <span className="block text-[10px] text-muted-foreground">
                {t("অনলাইনে ভিডিও কল", "Online video call")}
              </span>
            </span>
          </Link>
        </div>
      ...
      <section className="mt-3 grid grid-cols-2 gap-3 lg:grid-cols-4">
        {[
          {
            icon: ShieldCheck,
            t: t("১০০% অরিজিনাল", "100% authentic"),
            s: t("সরাসরি কোম্পানি সোর্স", "Direct from company source"),
          },
          {
            icon: Truck,
            t: t("দ্রুত ডেলিভারি", "Fast delivery"),
            s: t("ঢাকায় ২ ঘণ্টা", "2 hours in Dhaka"),
          },
          {
            icon: BadgePercent,
            t: t("সেরা দামে", "Best price"),
            s: t("১৫% পর্যন্ত ছাড়", "Up to 15% off"),
          },
          {
            icon: Clock,
            t: t("২৪/৭ সাপোর্ট", "24/7 support"),
            s: t("লাইসেন্সপ্রাপ্ত ফার্মাসিস্ট", "Licensed pharmacists"),
          },
        ...
        <div className="surface-card grid grid-cols-[minmax(0,1fr)_auto] items-center gap-4 p-4 sm:flex">
          ...
          <div className="min-w-0">
            <p className="font-display text-sm font-bold text-navy">
              {t("প্রেসক্রিপশন আপলোড করুন", "Upload your prescription")}
            </p>
            <p className="text-xs text-muted-foreground">
              {t(
                "ছবি দিন — ফার্মাসিস্ট ঔষধ সাজিয়ে অর্ডার নিশ্চিত করবেন",
                "Send a photo — a pharmacist will prepare and confirm your order",
              )}
            </p>
          </div>
          <Link
          ...
          {categories
            ...
            .map((c) => (
              <Link
                key={c.slug}
                href={
                  c.serviceRoute === "/home-diagnostics"
                    ? "/home-diagnostics"
                    : `/home-services?s=${encodeURIComponent(c.slug)}`
                }
      ...
      <section className="pt-8">
        <SectionTitle
          title={t("জনপ্রিয় ঔষধ", "Popular medicines")}
        ...
        <div className="grid gap-3 lg:grid-cols-3">
          <div className="relative overflow-hidden rounded-2xl bg-navy p-6 text-navy-foreground lg:col-span-2">
            ...
            <p className="mt-1 font-display text-3xl font-extrabold">
              {t("১৫% পর্যন্ত ছাড়", "Up to 15% off")}
            </p>
            <p className="mt-1 text-xs opacity-75">
              {t(
                "নিয়মিত ঔষধে সাবস্ক্রিপশন করলে বাড়তি সাশ্রয়।",
                "Subscribe to regular medicines for extra savings.",
              )}
            </p>
            <Link
              href="/offers"
          ...
          <div className="relative overflow-hidden rounded-2xl">
            <img
              src={typeof bannerPharmacist === "string" ? bannerPharmacist : bannerPharmacist.src}
            ...
            <div className="absolute inset-0 flex flex-col justify-end bg-linear-to-t from-navy/85 to-transparent p-4 text-navy-foreground">
              <p className="font-display text-sm font-bold">
                {t("ফার্মাসিস্টের ফ্রি পরামর্শ", "Free pharmacist consultation")}
              </p>
      ...
      <section className="pt-8">
        <SectionTitle
          title={t("জনপ্রিয় ল্যাব টেস্ট", "Popular lab tests")}
          to="/lab-test"
          label={t("সব দেখুন", "See all")}
        />
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {labTests.slice(0, 4).map((lt) => (
            <Link
              key={lt.id}
              href="/lab-test"
              className="surface-card flex items-center gap-3 p-3.5 transition hover:border-primary"
            >
              <span className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-secondary">
                🧪
              </span>
              ...
              <span className="ml-auto shrink-0 font-display text-sm font-extrabold text-primary">
                {t.money(lt.price)}
              </span>
            </Link>
          ))}
      ...
      <section className="pt-8">
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          {[
            {
              n: t("রিফাত হাসান", "Rifat Hasan"),
              r: t("সময়মতো ডেলিভারি পেয়েছি, দামও কম।", "Got timely delivery and low prices."),
            },
            {
              n: t("নুসরাত জাহান", "Nusrat Jahan"),
              r: t(
                "প্রেসক্রিপশন আপলোড করেই অর্ডার — খুব সহজ।",
                "Just uploaded my prescription to order — very easy.",
              ),
            },
            {
              n: t("তানভীর আহমেদ", "Tanvir Ahmed"),
              r: t(
                "জরুরি ঔষধ এক ঘণ্টার মধ্যেই হাতে পেয়েছি।",
                "Got emergency medicine within an hour.",
              ),
            },
          ].map((c) => (
