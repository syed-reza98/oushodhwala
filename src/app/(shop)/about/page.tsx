  ...
  return (
    <div className="pt-4">
      ...
      <div className="mt-4 grid gap-2 sm:grid-cols-3">
        {[
          {
            t: { bn: "১০০% অরিজিনাল", en: "100% Genuine" },
            d: { bn: "ডিজিডিএ অনুমোদিত সোর্স", en: "DGDA-approved source" },
          },
          {
            t: { bn: "লাইসেন্সপ্রাপ্ত ফার্মাসিস্ট", en: "Licensed Pharmacists" },
            d: { bn: "প্রতিটি অর্ডার যাচাই", en: "Every order verified" },
          },
          {
            t: { bn: "৬৪ জেলায় ডেলিভারি", en: "Delivery in 64 Districts" },
            d: { bn: "কোল্ড-চেইন সাপোর্টসহ", en: "With cold-chain support" },
          },
        ].map((x) => (
      ...
      <h2 className="mt-6 text-sm font-bold">
        {t("৩ ধাপে ঔষধ অর্ডার", "Order Medicine in 3 Steps")}
      </h2>
      <ol className="mt-2 space-y-2 text-xs">
        {[
          {
            bn: "ধাপ ১ — খুঁজুন: ব্র্যান্ড, জেনেরিক বা প্রস্তুতকারকের নাম দিয়ে ঔষধ খুঁজে দাম দেখুন।",
            en: "Step 1 — Search: Find medicine by brand, generic or manufacturer name and check prices.",
          },
          {
            bn: "ধাপ ২ — প্রেসক্রিপশন আপলোড: প্রয়োজনে প্রেসক্রিপশনের ছবি দিন, ফার্মাসিস্ট যাচাই করবেন।",
            en: "Step 2 — Upload prescription: If needed, upload a photo of your prescription for pharmacist verification.",
          },
          {
            bn: "ধাপ ৩ — হোম ডেলিভারি: ঢাকায় একই দিনে, সারাদেশে ২৪-৭২ ঘণ্টায় ডেলিভারি নিন।",
            en: "Step 3 — Home delivery: Same-day in Dhaka, 24-72 hours nationwide.",
          },
        ].map((s) => (
          <li
            key={s.bn}
            className="rounded-xl border border-border bg-card p-3 text-muted-foreground"
          >
            {t(s.bn, s.en)}
          </li>
        ))}
